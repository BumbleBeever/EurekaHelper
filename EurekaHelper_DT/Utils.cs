...
namespace EurekaHelper_DT
{
    ...
    internal class Utils
    {
        ...
        public static unsafe void AddMapMarker(ushort territoryId, Vector3 position, uint iconId, bool openMap = false)
        {
            ...
            {
                EurekaHelper_DT.PrintMessage("You must be in the same zone to place a marker.");
                return;
            }
        ...
        public static string RandomFormattedText(EurekaFate fate)
        {
            ...
            int index = random.Next(EurekaHelper_DT.Config.CustomMessages.Count);
            string randomMessage = EurekaHelper_DT.Config.CustomMessages[index];
