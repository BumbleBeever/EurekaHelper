...
{
    public class EurekaHelper_DT : IDalamudPlugin
    {
        public string Name => "Eureka Helper";
        public static Configuration Config { get; private set; }
        public static EurekaHelper_DT Plugin { get; private set; }
        ...
        public EurekaHelper_DT(IDalamudPluginInterface pluginInterface)
        {
            Plugin = this;
